...
<head>
    ...
    <title inertia>{{ config('app.name', 'Talenta') }}</title>
    ...
    <meta name="keywords"
        content="Talenta, platform edukasi, pembelajaran online, kelas online, webinar, bootcamp, pengembangan keterampilan, kursus digital">
    <meta name="author" content="Talenta">
