    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-4 py-4 md:px-6">
                ...
                <div className={`${canManageAffiliate ? 'lg:grid-cols-3' : ''} grid grid-cols-1 gap-4 lg:gap-6`}>
                    <Tabs defaultValue="detail" className={canManageAffiliate ? 'lg:col-span-2' : 'w-full'}>
                        <TabsList>
