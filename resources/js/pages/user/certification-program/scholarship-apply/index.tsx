                ...
                <section className="mx-auto w-full max-w-5xl px-4 py-12">
                    <div className="mb-8 px-4">
                        <div className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span>/</span>
                            <span className="text-gray-900 dark:text-white">Beasiswa</span>
                        </div>
                                        ...
                                        <FormField control={form.control} name="whatsapp_share_photo" render={({ field: { onChange, value, ...field } }) => {
                                            void value; return (
                                                <FormItem><FormLabel className="flex items-center gap-2"><span>💬</span> Screenshot Share Postingan Instagram ke 1 Grup WhatsApp *</FormLabel><FormControl><div className="space-y-3">
                                                    {waSharePreview && <div className="relative overflow-hidden rounded-lg border-2 border-emerald-300 bg-gradient-to-br from-emerald-50 to-green-50 p-2 dark:from-emerald-950/30 dark:to-green-950/30"><img src={waSharePreview} alt="WA Share Preview" className="h-40 w-full rounded object-contain" /><div className="absolute top-2 right-2 rounded-full bg-emerald-500 px-2 py-1 text-xs font-semibold text-white">✓ Terpilih</div></div>}
