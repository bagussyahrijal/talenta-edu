...
export default function Referral({
    ...
    const handleShareWhatsApp = () => {
        const text = `Hai! Belajar di Talenta menggunakan kode referral saya ${referralCode} atau klik link berikut untuk daftar dan dapatkan bonus poin langsung: ${shareUrl}`;
            ...
            <ProfileLayout>
                <div className="space-y-6">
                    <Heading
                        ...
                        description="Undang teman belajar bersama di Talenta dan kumpulkan koin reward untuk potongan harga."
                    />
